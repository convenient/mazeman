...
enum opt_code
{
  ...
  OPT_mapcs = 1138,                          /* -mapcs */
  OPT_mapcs_float = 1139,                    /* -mapcs-float */
  OPT_mapcs_frame = 1140,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1141,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1142,              /* -mapcs-stack-check */
  OPT_march_ = 1143,                         /* -march= */
  OPT_marm = 1144,                           /* -marm */
  OPT_masm_syntax_unified = 1145,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1146,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1147,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1148,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1149,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1150,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1151,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1152,                  /* -mfp16-format= */
  OPT_mfpu_ = 1153,                          /* -mfpu= */
  /* OPT_mhard_float = 1154, */              /* -mhard-float */
  OPT_mlittle_endian = 1155,                 /* -mlittle-endian */
  OPT_mlong_calls = 1156,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1157,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1158,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1159,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1160,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1161,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1162,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1163,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1164,                   /* -mrestrict-it */
  OPT_msched_prolog = 1165,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1166,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1167,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1168, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1169,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1170,                         /* -mthumb */
  OPT_mthumb_interwork = 1171,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1172,                  /* -mtls-dialect= */
  OPT_mtp_ = 1173,                           /* -mtp= */
  OPT_mtpcs_frame = 1174,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1175,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1176,                         /* -mtune= */
  OPT_munaligned_access = 1177,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1178,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1179,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1180,              /* -mword-relocations */
  OPT_n = 1181,                              /* -n */
  OPT_no_canonical_prefixes = 1182,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1183,              /* -no-integrated-cpp */
  OPT_nocpp = 1184,                          /* -nocpp */
  OPT_nodefaultlibs = 1185,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1186,                   /* -nostartfiles */
  OPT_nostdinc = 1187,                       /* -nostdinc */
  OPT_nostdinc__ = 1188,                     /* -nostdinc++ */
  OPT_nostdlib = 1189,                       /* -nostdlib */
  OPT_o = 1190,                              /* -o */
  OPT_p = 1191,                              /* -p */
  OPT_pass_exit_codes = 1192,                /* -pass-exit-codes */
  /* OPT_pedantic = 1193, */                 /* -pedantic */
  OPT_pedantic_errors = 1194,                /* -pedantic-errors */
  OPT_pg = 1195,                             /* -pg */
  OPT_pie = 1196,                            /* -pie */
  OPT_pipe = 1197,                           /* -pipe */
  OPT_print_file_name_ = 1198,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1199,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1200,          /* -print-multi-directory */
  OPT_print_multi_lib = 1201,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1202,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1203,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1204,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1205,               /* -print-prog-name= */
  OPT_print_search_dirs = 1206,              /* -print-search-dirs */
  OPT_print_sysroot = 1207,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1208,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1209,                          /* -quiet */
  OPT_r = 1210,                              /* -r */
  OPT_remap = 1211,                          /* -remap */
  OPT_s = 1212,                              /* -s */
  OPT_s_bc_abi = 1213,                       /* -s-bc-abi */
  OPT_save_temps = 1214,                     /* -save-temps */
  OPT_save_temps_ = 1215,                    /* -save-temps= */
  OPT_shared = 1216,                         /* -shared */
  OPT_shared_libgcc = 1217,                  /* -shared-libgcc */
  /* OPT_specs = 1218, */                    /* -specs */
  OPT_specs_ = 1219,                         /* -specs= */
  OPT_static = 1220,                         /* -static */
  OPT_static_libasan = 1221,                 /* -static-libasan */
  OPT_static_libgcc = 1222,                  /* -static-libgcc */
  OPT_static_libgcj = 1223,                  /* -static-libgcj */
  OPT_static_libgfortran = 1224,             /* -static-libgfortran */
  OPT_static_libgo = 1225,                   /* -static-libgo */
  OPT_static_liblsan = 1226,                 /* -static-liblsan */
  OPT_static_libmpx = 1227,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1228,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1229,               /* -static-libstdc++ */
  OPT_static_libtsan = 1230,                 /* -static-libtsan */
  OPT_static_libubsan = 1231,                /* -static-libubsan */
  /* OPT_std_c__03 = 1232, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1233, */                /* -std=c++0x */
  OPT_std_c__11 = 1234,                      /* -std=c++11 */
  OPT_std_c__14 = 1235,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1236, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1237, */                /* -std=c++1y */
  OPT_std_c__1z = 1238,                      /* -std=c++1z */
  OPT_std_c__98 = 1239,                      /* -std=c++98 */
  OPT_std_c11 = 1240,                        /* -std=c11 */
  /* OPT_std_c1x = 1241, */                  /* -std=c1x */
  /* OPT_std_c89 = 1242, */                  /* -std=c89 */
  OPT_std_c90 = 1243,                        /* -std=c90 */
  OPT_std_c99 = 1244,                        /* -std=c99 */
  /* OPT_std_c9x = 1245, */                  /* -std=c9x */
  OPT_std_f2003 = 1246,                      /* -std=f2003 */
  OPT_std_f2008 = 1247,                      /* -std=f2008 */
  OPT_std_f2008ts = 1248,                    /* -std=f2008ts */
  OPT_std_f95 = 1249,                        /* -std=f95 */
  OPT_std_gnu = 1250,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1251, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1252, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1253,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1254,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1255, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1256, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1257,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1258,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1259,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1260, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1261, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1262,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1263,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1264, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1265, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1266,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1267, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1268, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1269, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1270,                     /* -std=legacy */
  OPT_symbolic = 1271,                       /* -symbolic */
  OPT_t = 1272,                              /* -t */
  OPT_time = 1273,                           /* -time */
  OPT_time_ = 1274,                          /* -time= */
